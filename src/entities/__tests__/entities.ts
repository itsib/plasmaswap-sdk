...
import { ChainId, LiquidityProvider, Pair, Rounding, Route, Token, TokenAmount, Trade, TradeType, WNATIVE as _WETH } from '../../index';
    ...
    describe(`decimals permutation: ${decimals}`, () => {
      ...
      describe('Trade', () => {
        ...
        it('TradeType.EXACT_INPUT', () => {
          route = new Route(
            [new Pair(new TokenAmount(tokens[1], decimalize(5, tokens[1].decimals)), new TokenAmount(WETH, decimalize(10, WETH.decimals)), LiquidityProvider.UNISWAP)],
            tokens[1],
          );
